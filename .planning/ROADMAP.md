...
- [x] 03-03-PLAN.md — Danh sách/theo ngày/chi tiết, cộng gộp danh mục con (TXN-01, TXN-02, TXN-08)
- [x] 03-04-PLAN.md — Tạo hàng loạt, mỗi dòng 1 DB transaction, 1 Idempotency-Key cho cả lô (TXN-04)
...
- [x] 04-03-PLAN.md — Sổ nợ: tạo/trả/huỷ trả/write-off/xoá qua TransactionWriter, ranh giới trigger V4 (DEBT-01..06; DEBT-07 chỉ phần truy vấn, job ở Plan 07)
